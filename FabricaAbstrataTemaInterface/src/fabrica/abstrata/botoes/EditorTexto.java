...
import fabrica.abstrata.botoes.FabricaBotoesPadrao;
import fabrica.abstrata.botoes.FabricaBotoesIcon;
...
public class EditorTexto extends javax.swing.JFrame {
    ...
    private void addButtons(String tema){        
        if(tema.equalsIgnoreCase("tema1")){
		  fabrica = new FabricaBotoesPadrao();
        }else if(tema.equalsIgnoreCase("tema2")){
		  fabrica = new FabricaBotoesIcon();
        } 
